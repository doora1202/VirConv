...
class KittiDatasetMM(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        database_save_path = Path(self.root_path) / ('my_gt_database_mm' if split == 'train' else ('my_gt_database_%s_mm' % split))
        db_info_save_path = Path(self.root_path) / ('my_kitti_dbinfos_%s_mm.pkl' % split)
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    train_filename = save_path / ('my_kitti_infos_%s.pkl' % train_split)
    val_filename = save_path / ('my_kitti_infos_%s.pkl' % val_split)
    trainval_filename = save_path / 'my_kitti_infos_trainval.pkl'
    test_filename = save_path / 'my_kitti_infos_test.pkl'
